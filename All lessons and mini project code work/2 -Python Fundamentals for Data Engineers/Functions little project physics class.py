...
energy = mass * c
print("A 1kg bomb supplies " + str(energy) + " Joules energy")

get_energy(bomb_mass)

def get_work(mass,acceleration,distance):
get_force = mass _acceleration
train_work=get_force _ distance
print(train_work)
